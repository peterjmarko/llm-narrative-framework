# Contributing to the LLM Narrative Framework
...
*   **Details:** For the exact file paths and structure, see the detailed note in the **[🧪 Testing Guide (TESTING.md)](TESTING.md)** in the "Data Preparation Pipeline" integration testing section.
...
-   **Examples:** `CONTRIBUTING.md`, `ROADMAP.md`.
