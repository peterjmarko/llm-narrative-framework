...
It is the final step in the `evaluate_study.ps1` workflow.
...
def main():
    ...
    relative_log_path = os.path.relpath(log_filepath, project_root)
    logging.info(f"Full analysis log is being saved to:\n{relative_log_path}")
    logging.info("="*80 + "\n") # Another separator
    ...
    try:
        ...
        relative_csv_path = os.path.relpath(master_csv_path, project_root)
        logging.info(f"Successfully loaded {len(df)} rows from:\n{relative_csv_path}\n") # Add newline for spacing
    except Exception as e:
