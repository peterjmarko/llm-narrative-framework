...
*   **Data**: Modifications to data files should be handled carefully.
    -   **`data/foundational_assets/`**: Changes to these files (e.g., `point_weights.csv`, neutralized delineations) will alter the database generation logic. Justify these changes in your pull request.
