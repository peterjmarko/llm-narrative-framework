...
-   **`adb_filtered_5000.txt`**: The output of `filter_adb_candidates.py`. It contains the top 5,000 subjects, sorted by eminence, with all necessary data for the next step.
...
-   **`personalities_db.txt`**: This is the final, primary database used in all experiments. It is generated by `generate_personalities_db.py` from `processed/subject_db.csv`.
