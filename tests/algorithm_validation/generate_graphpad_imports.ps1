...
function Export-BiasRegressionDataForGraphPad {
    ...
    Write-Host "  Generated: Phase_B_Bias_Regression_MRR.csv (TrialSeq vs MRR, $($overallMRRData.Count) points)"
    ...
    Write-Host "  Generated: Phase_B_Bias_Regression_Top1.csv (TrialSeq vs Top1Accuracy, $($overallTop1Data.Count) points)"
    ...
    Write-Host "  Generated: Phase_B_Bias_Regression_Top3.csv (TrialSeq vs Top3Accuracy, $($overallTop3Data.Count) points)"
    ...
    if ($correctData.Count -gt 0) {
        ...
        Write-Host "  Generated: Phase_B_Bias_Regression_Correct_MRR.csv ($($correctMRRData.Count) points)"
    }
    ...
    if ($randomData.Count -gt 0) {
        ...
        Write-Host "  Generated: Phase_B_Bias_Regression_Random_MRR.csv ($($randomMRRData.Count) points)"
    }
...
# =============================================================================
# GRAPHPAD VALIDATION INSTRUCTIONS
# =============================================================================

# Removed duplicate Show-GraphPadValidationInstructions function
# (functionality merged into Show-Phase3ValidationInstructions)
