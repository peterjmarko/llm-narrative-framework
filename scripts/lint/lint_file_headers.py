...
#
# Filename: scripts/lint/lint_file_headers.py
...
Usage:
    ...
    python scripts/lint/lint_file_headers.py

    # Automatically fix all non-compliant scripts
    python scripts/lint/lint_file_headers.py --fix
    
    # Check a specific file or pattern
    python scripts/lint/lint_file_headers.py "src/some_specific_script.py"
"""
