...
-   [`maintenance/`](maintenance/): Contains scripts for general project upkeep. A key utility is `list_project_files.py`, which generates detailed project structure reports. This section also includes tools for cleaning temporary files and managing the workspace.
