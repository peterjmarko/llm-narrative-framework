<!--
================================================================================
!!! DO NOT EDIT 'docs/EXPERIMENT_WORKFLOW_DATA_DICTIONARY.md' DIRECTLY !!!
...
<div align="center">
  <p>Project Architecture: The `output/` directory stores results from the core experiment and analysis logic.</p>
  <img src="images/arch_project_overview.png" width="100%">
</div>
...
<div align="center">
  <p>Data Flow Diagram: Creation and transformation of data artifacts through the experiment workflow.</p>
  <img src="images/data_main_flow.png" width="80%">
</div>
