...
{{grouped_figure:docs/diagrams/architecture_workflow_1_run_experiment.mmd | scale=2.5 | width=100% | caption=Workflow 1: Run an Experiment, showing the main control loop and the internal replication pipeline.}}
