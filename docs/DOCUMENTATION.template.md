...
{{diagram:docs/diagrams/flow_stimulus_generation.mmd | scale=2.5 | width=100% | caption=Figure SX: The four-stage process for generating the experimental stimuli.}}
