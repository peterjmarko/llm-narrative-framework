# Experiment and Study Workflow Data Dictionary

This document is the **Experiment and Study Workflow Data Dictionary** for the project. It describes the contents and structure of the `output/` directory, explaining the role of each file in the experiment execution, result aggregation, and statistical analysis workflows.
...
- **[📊 Data Preparation Data Dictionary](DATA_PREPARATION_DATA_DICTIONARY.md)** - Specifications for `data/` directory (the foundation for experiments)
- **[🔬 Replication Guide](REPLICATION_GUIDE.md)** - Procedures that generate these files
- **[📖 README](../README.md)** - Project overview

---

The `output/` directory contains the experimental results and statistical analyses generated by the core framework logic, building upon the foundation provided by the data preparation pipeline documented in the Data Preparation Data Dictionary.
...
│       ├── config.ini.archived     # Archived configuration
│       ├── EXPERIMENT_results.csv  # Aggregated experiment results
│       ├── EXPERIMENT_log.txt      # Experiment status log
│       └── rep-[N]_run_[timestamp]/
│           ├── REPLICATION_results.csv     # Single replication results
│           ├── replication_report_[timestamp].txt
│           ├── replication_metrics.json    # Enhanced metrics
│           ├── queries_[timestamp].txt
│           ├── responses_[timestamp].txt
│           └── logs_[timestamp].txt
│
└── studies/                        # Multi-experiment studies
    └── [StudyName]/
        ├── [ExperimentA]/          # Moved from experiments/
        ├── [ExperimentB]/          # Moved from experiments/
        ├── STUDY_results.csv       # Master aggregated dataset
...
For detailed information about the data preparation that feeds into this workflow, see the **[📁 Data Preparation Data Dictionary](DATA_PREPARATION_DATA_DICTIONARY.md)**. For comprehensive workflow documentation, see the **[📖 Framework Manual](../docs/FRAMEWORK_MANUAL.md)**.