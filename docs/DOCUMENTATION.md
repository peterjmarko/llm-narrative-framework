...
<div align="center">
  <p>Data Prep Flow 3: Profile Generation.</p>
...
<div align="center">
  <p>Overall Logic for the Data Preparation Pipeline: A high-level view of the four main stages.</p>
...
<div align="center">
  <p>Logic for Final Filtering (`select_eligible_candidates.py`): The algorithm for applying all deterministic data quality rules to create the final "eligible candidates" list.</p>
...
<div align="center">
  <p>Logic for OCEAN Scoring (`generate_ocean_scores.py`): The algorithm for generating OCEAN personality scores for all eligible subjects. A robust pre-flight check ensures that interrupted runs can be safely resumed.</p>
  <img src="images/logic_prep_ocean_scoring.png" width="60%">
</div>

<div align="center">
  <p>Logic for Final Selection (`select_final_candidates.py`): The algorithm for finding the optimal cohort size by performing a slope analysis on a smoothed cumulative personality variance curve.</p>
